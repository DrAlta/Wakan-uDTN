...
use wakan_sim::wakan::{
    Frontend, Graph, LocalMinimumClusterNode, LocalMinimumClusterPacket, RawNode, WakamSim,
    SIM_SIZE,
};

#[macroquad::main("Local Minimum Clusters Sim")]
pub async fn main() {
    let args: Vec<String> = env::args().collect();
    let graph: Graph<LocalMinimumClusterPacket, LocalMinimumClusterNode> =
